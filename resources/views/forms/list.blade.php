                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $research->proponents }}</td>
                      <td>{{ \Carbon\Carbon::parse($research->start_date)->format('F d, Y') }}</td>
                      <td>{{ \Carbon\Carbon::parse($research->end_date)->format('F d, Y') }}</td>
                      <td>
                        @php
                      ...
                      <td>
                        <div class="d-flex gap-2 align-items-center">
                          <!-- View Button -->
                          <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#researchModal{{ $research->id }}">
                          View
                          </button>
                          <!-- Edit Button -->
                          <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#editModal{{ $research->id }}">
                          Edit
                          </button>
                          <!-- Delete Form -->
                          <form action="{{ route('researches.destroy', $research->id) }}" method="POST" class="m-0 p-0">
                            @csrf
                            @method('DELETE')
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-4">
                                      ...
                                      <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="project_type" name="project_type" value="{{ $research->project_type }}" required>
                                      </div>
                                      <div class="mb-3">
                                        <label for="proponents" class="form-label">Proponents</label>
                                        <input type="text" class="form-control" id="proponents" name="proponents" value="{{ $research->proponents }}">
                                      </div>
                                    </div>
                                    {{-- Column 2 --}}
                                    <div class="col-md-4">
                                      <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="start_date" name="start_date" value="{{ $research->start_date }}" required>
                                      </div>
                                      <div class="mb-3">
                                        <label for="end_date" class="form-label">End Date</label>
                                        <input type="date" class="form-control" id="end_date" name="end_date" value="{{ $research->end_date }}" required>
                                      </div>
                                      <div class="mb-3">
                                        <label for="months" class="form-label">Months</label>
                                        <input type="number" class="form-control" id="months" name="months" value="{{ $research->months }}">
                                      </div>
                                    </div>
                                    {{-- Column 3 --}}
                                    <div class="col-md-4">
                                      <div class="mb-3">
                                        ...
                                        <option value="pending" {{ $research->status === 'pending' ? 'selected' : '' }}>Pending</option>
                                        <option value="approved" {{ $research->status === 'approved' ? 'selected' : '' }}>Approved</option>
                                        <option value="ongoing" {{ $research->status === 'ongoing' ? 'selected' : '' }}>Ongoing</option>
                                        <option value="rejected" {{ $research->status === 'rejected' ? 'selected' : '' }}>Rejected</option>
                                        <option value="declined" {{ $research->status === 'declined' ? 'selected' : '' }}>Declined</option>
                                        <option value="completed" {{ $research->status === 'completed' ? 'selected' : '' }}>Completed</option>
                                        </select>
                                      </div>
                                      <div class="mb-3">
                                        <label for="document_link" class="form-label fw-bold">Google Drive Folder Link</label>
                                        <input type="url" class="form-control" id="document_link" name="document_link" value="{{ $research->document_link }}">
                                      </div>
                                    </div>
                                  </div>
                                  {{-- Full Width Section for Description and Embed --}}
                                  <div class="mt-4">
                                    <div class="mb-3">
                                      <label for="description" class="form-label">Description</label>
                                      <textarea class="form-control" id="description" name="description" rows="3">{{ $research->description }}</textarea>
                                    </div>
                                    @php
                                    ...
                                    @elseif (!empty($research->document_link))
