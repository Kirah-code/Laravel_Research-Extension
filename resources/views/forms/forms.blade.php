          ...
          <div class="page-inner">
            <div class="page-header">
              ...
              <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item"><a href="{{ url('dashboard/upload') }}">Upload</a></li>
              </ul>
            </div>
            @if (session('success'))
                ...
                <div class="col-md-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="form-group mb-3">
                            ...
                            <textarea name="proponents" class="form-control" rows="3" placeholder="Enter names separated by commas or new lines">{{ old('proponents') }}</textarea>
                          </div>
                        </div>
                        <!-- Column 2 -->
                        <div class="col-md-4">
                          ...
                          <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" name="description" rows="4" placeholder="(Optional) Add notes about the research">{{ old('description') }}</textarea>
                          </div>
                        </div>
                        <!-- Column 3 -->
                        <div class="col-md-4">
                      ...
                      <div class="row mt-4">
                        <div class="col-12">
                          ...
                          <div class="row mb-2">
                            <h6 class="mb-1">{{ ucfirst($year) }}</h6>
                            @foreach (['q1', 'q2', 'q3', 'q4'] as $q)
                            <div class="col-md-3 mb-3">
                              <label for="{{ $year }}_{{ $q }}_link">{{ strtoupper($year) }} {{ strtoupper($q) }} Link</label>
                              <input type="url" name="{{ $year }}_{{ $q }}_link" class="form-control" placeholder="https://drive.google.com/drive/folders/...">
                            </div>
                            @endforeach
                          </div>
                          @endforeach
                    ...
                    <div class="card-action text-end px-4 pb-3">
                      ...
                      <a href="{{ route('researches.index') }}" class="btn btn-danger">Cancel</a>
                    </div>
                  </div>
                </div>
              </div>
