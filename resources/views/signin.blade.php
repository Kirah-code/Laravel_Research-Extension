  ...
  <div class="bg-[#22001f]/90 shadow-2xl rounded-2xl p-8 w-full max-w-md" id="container">
    ...
    <div class="flex justify-center space-x-4 mb-6">
      <div class="w-16 h-16 rounded-full overflow-hidden border-2 border-white">
        <img src="{{ asset('assets/img/bagong_pilipinas.jpg') }}" alt="Logo 1" class="object-cover w-full h-full" />
      </div>
      <div class="w-16 h-16 rounded-full overflow-hidden border-2 border-white">
        <img src="{{ asset('assets/img/tup_logo.png') }}" alt="Logo 2" class="object-cover w-full h-full" />
      </div>
      <div class="w-16 h-16 rounded-full overflow-hidden border-2 border-white">
