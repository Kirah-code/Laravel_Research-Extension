...
<html lang="en">
  ...
  <body>
          ...
          <div class="page-inner">
            ...
            <div class="card mx-auto mt-5" style="max-width: 600px;">
              <div class="card-header">
                <h4 class="card-title text-center">Register New User</h4>
              </div>
              <div class="card-body">
    ...
    <!-- Bootstrap Notify -->
    <script src="../assets/js/plugin/bootstrasp-notify/bootstrap-notify.min.js"></script>
    <!-- jQuery Vector Maps -->
...
</html><?php /**PATH C:\xampp\htdocs\ojt_project\resources\views/users/users_add.blade.php ENDPATH**/ ?>