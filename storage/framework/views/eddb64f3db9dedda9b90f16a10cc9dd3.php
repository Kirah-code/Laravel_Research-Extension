          ...
          <div class="sidebar-content">
            <ul class="nav nav-secondary">
              ...
              <li class="nav-item active">
                ...
                <div class="show" id="researchExtension">
                  <ul class="nav nav-collapse">
                    <li class="nav-item">
        ...
        <div class="container">
          ...
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">Division</h3>
              <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                  <a href="<?php echo e(url('dashboard/division')); ?>">Research and Extension Division</a>
                </li>
              </ul>
            </div>
            <div class="mb-4">
              <img src="<?php echo e(asset('../assets/img/rande.jpg')); ?>" alt="Research and Extension Division" class="img-fluid">
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\ojt_project\resources\views/division/research_extension.blade.php ENDPATH**/ ?>