        ...
        <div class="container">
          ...
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">Upload Research</h3>
              <ul class="breadcrumbs mb-3">
                <li class="nav-home">
                  <a href="<?php echo e(url('/dashboard')); ?>"><i class="icon-home"></i></a>
                </li>
                <li class="separator"><i class="icon-arrow-right"></i></li>
                <li class="nav-item"><a href="<?php echo e(url('dashboard/upload')); ?>">Upload</a></li>
              </ul>
            </div>
            ...
            <?php endif; ?>
            <form action="<?php echo e(route('researches.store')); ?>" method="POST">
              <?php echo csrf_field(); ?>
              <div class="row">
                <div class="col-md-12">
                  <div class="card">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="form-group mb-3">
                            ...
                            <textarea name="proponents" class="form-control" rows="3" placeholder="Enter names separated by commas or new lines"><?php echo e(old('proponents')); ?></textarea>
                          </div>
                        </div>
                        <!-- Column 2 -->
                        <div class="col-md-4">
                          ...
                          <div class="form-group mb-3">
                            ...
                            <input type="number" name="months" class="form-control" placeholder="e.g., 6 or 12">
                          </div>
                          <div class="form-group mb-3">
                            <label for="description">Description / Notes</label>
                            <textarea class="form-control" name="description" rows="4" placeholder="(Optional) Add notes about the research"><?php echo e(old('description')); ?></textarea>
                          </div>
                        </div>
                        <!-- Column 3 -->
                        <div class="col-md-4">
                          <div class="form-group mb-3">
                          <label for="user_ids">Author / Co-Authors</label>
                          ...
                          <div class="form-group mb-3">
                            <label for="imrad_link">IMRAD Zip</label>
                            <input type="url" name="imrad_link" class="form-control" placeholder="https://drive.google.com/file/d/ZIP-ID/view?usp=sharing">
                            <small class="text-muted">Paste direct ZIP file link from Google Drive.</small>
                          </div>
                          <div class="form-group mb-3">
                            <label for="moa_link">Research Contract Zip</label>
                            <input type="url" name="moa_link" class="form-control" placeholder="https://drive.google.com/drive/folders/...">
                          </div>
                          <div class="form-group mb-3">
                            <label for="mou_link">MOU Zip</label>
                            <input type="url" name="mou_link" class="form-control" placeholder="https://drive.google.com/drive/folders/...">
                          </div>
                        </div>
                      </div>
                      <!-- Yearly Quarterly Google Drive Links -->
                      <div class="row mt-4">
                        <div class="col-12">
                          <h5>Yearly Progress Report</h5>
                          <?php $__currentLoopData = ['year1', 'year2', 'year3']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <div class="row mb-2">
                            <h6 class="mb-1"><?php echo e(ucfirst($year)); ?></h6>
                            ...
                            <div class="col-md-3 mb-3">
                              <label for="<?php echo e($year); ?>_<?php echo e($q); ?>_link"><?php echo e(strtoupper($year)); ?> <?php echo e(strtoupper($q)); ?> Link</label>
                              <input type="url" name="<?php echo e($year); ?>_<?php echo e($q); ?>_link" class="form-control" placeholder="https://drive.google.com/drive/folders/...">
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </div>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="card-action text-end px-4 pb-3">
                      <button class="btn btn-success" type="submit">Submit</button>
                      <a href="<?php echo e(route('researches.index')); ?>" class="btn btn-danger">Cancel</a>
                    </div>
                  </div>
                </div>
              </div>
...
</html><?php /**PATH C:\xampp\htdocs\ojt_project\resources\views/forms/forms.blade.php ENDPATH**/ ?>