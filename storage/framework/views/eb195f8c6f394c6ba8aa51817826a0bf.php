...
<?php $__currentLoopData = $ongoingResearches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $research): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="page-inner">
            ...
            <?php endif; ?>
            <form action="<?php echo e(route('extensions.store')); ?>" method="POST">
              <?php echo csrf_field(); ?>
              <div class="row">
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-header">
                      <div class="card-title">Extension Project</div>
                    </div>
                    <div class="card-body">
                      <div class="row">
                        <!-- Column 1: Title, Type, Status -->
                        <div class="col-md-3">
                        ...
                        <!-- Column 3: User & Proponents -->
                        <div class="col-md-3">
                          <div class="form-group mb-3">
                          <label for="user_ids">Project Leader/Members</label>
                          ...
                          <div class="form-group mb-3">
                            <label for="proponents">Additional Proponents</label>
                            <textarea name="proponents" class="form-control" rows="2" placeholder="Enter proponents' names"></textarea>
                          </div>
                          <div class="form-group mb-3">
                        ...
                        <!-- Column 4: Drive Links (ZIPs) -->
                        <div class="col-md-3">
                          <div class="form-group mb-3">
                            <label for="terminal_report">Terminal Report (ZIP Link)</label>
                            <input type="url" name="terminal_report" class="form-control"
                              placeholder="https://drive.google.com/file/d/ZIP-ID/view?usp=sharing" required>
                          </div>
                          <div class="form-group mb-3">
                            <label for="moa">MOA (ZIP Link)</label>
                            <input type="url" name="moa" class="form-control"
                              placeholder="https://drive.google.com/file/d/ZIP-ID/view?usp=sharing" required>
                          </div>
                          <div class="form-group mb-3">
                            <label for="mou">MOU (ZIP Link)</label>
                            <input type="url" name="mou" class="form-control"
                              placeholder="https://drive.google.com/file/d/ZIP-ID/view?usp=sharing" required>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card-action text-end px-4 pb-3">
                      ...
                      <a href="<?php echo e(route('extensions.index')); ?>" class="btn btn-danger">Cancel</a>
                    </div>
                  </div>
                </div>
              </div>
...
</html><?php /**PATH C:\xampp\htdocs\ojt_project\resources\views/forms/extension.blade.php ENDPATH**/ ?>