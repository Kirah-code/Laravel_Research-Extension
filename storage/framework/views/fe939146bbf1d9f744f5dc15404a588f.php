    ...
    <div class="main-panel">
                  ...
                  <li>
                    <div class="notif-scroll scrollbar-outer">
                      <div class="notif-center">
                        ...
                        <a href="#" class="notification-item" data-id="<?php echo e($notif->id); ?>">
                          <div class="notif-icon notif-<?php echo e($notif->type ?? 'info'); ?> <?php echo e($notif->read ? '' : 'unread'); ?>">
                            <i class="fa fa-info-circle"></i>
                          </div>
                          <div class="notif-content">
                            <span class="block">
                            <strong><?php echo e(\Illuminate\Support\Str::limit($notif->title, 30)); ?></strong>
                            </span>
                            <span class="block">
      ...
      <div class="container">
        ...
        <div class="page-inner">
          <div class="dashboard-section position-relative text-white" style="background-image: url('<?php echo e(asset('assets/img/dashboard-bg.jpg')); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat; border-radius: 15px; overflow: hidden; padding: 2rem;">
            <!-- Slideshow Dashboard Wrapper -->
            <div class="slideshow-wrapper my-4 rounded-4 overflow-hidden">
              <!-- Background Slideshow Images -->
              <div class="slideshow-bg">
                <div class="slide" style="background-image: url('<?php echo e(asset('assets/img/s1.jpg')); ?>');"></div>
                <div class="slide" style="background-image: url('<?php echo e(asset('assets/img/s2.jpg')); ?>');"></div>
                <div class="slide" style="background-image: url('<?php echo e(asset('assets/img/s3.jpg')); ?>');"></div>
              </div>
              <!-- Overlay -->
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                              <?php $__currentLoopData = $allResearches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $research): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                                <td><?php echo e($loop->iteration); ?></td>
                                <td><?php echo e($research->title); ?></td>
                                <td><?php echo e(ucfirst($research->status)); ?></td>
                                <td><?php echo e($research->created_at->format('M d, Y')); ?></td>
                              </tr>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                          </table>
                        ...
                        <table class="table table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td><?php echo e(ucfirst($extension->status ?? 'N/A')); ?></td>
                              <td><?php echo e($extension->created_at->format('M d, Y')); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </tbody>
                        </table>
                    ...
                    <div class="card-tools">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          <a class="dropdown-item" href="<?php echo e(url('dashboard/list')); ?>">View All</a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-body p-0">
                  <div class="table-responsive">
                    <table class="table align-items-center mb-0">
                      ...
                      <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $ongoingResearches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $research): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                          <th scope="row">
                          ...
                          <td class="text-end"><?php echo e($research->proponents ?? 'Unknown'); ?></td>
                          <td class="text-end"><?php echo e(\Carbon\Carbon::parse($research->created_at)->toFormattedDateString()); ?></td>
                          <td class="text-end">
                            <span class="badge badge-info text-capitalize"><?php echo e($research->status ?? 'Ongoing'); ?></span>
                          </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                  ...
                  <div class="card-head-row card-tools-still-right">
                    ...
                    <div class="card-tools">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          <a class="dropdown-item" href="<?php echo e(url('dashboard/extension_list')); ?>">View All</a>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th scope="row">
                            ...
                            <?php echo e($extension->title); ?>

                          </th>
                          <td class="text-end"><?php echo e($extension->proponents ?? 'Unknown'); ?></td>
                          <td class="text-end"><?php echo e(\Carbon\Carbon::parse($extension->created_at)->toFormattedDateString()); ?></td>
                          <td class="text-end">
                            <span class="badge badge-info text-capitalize"><?php echo e($extension->status ?? 'Ongoing'); ?></span>
                          </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                ...
                <div class="card-body p-0">
                  <div class="table-responsive">
                    <table class="table align-items-center mb-0">
                      ...
                      <tbody>
                        <?php $__currentLoopData = $completedResearches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $research): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          <th scope="row">
                          ...
                          <td class="text-end"><?php echo e($research->proponents ?? 'N/A'); ?></td>
                          <td class="text-end"><?php echo e(\Carbon\Carbon::parse($research->created_at)->toFormattedDateString()); ?></td>
                          <td class="text-end">
                            <span class="badge badge-success text-capitalize"><?php echo e($research->status); ?></span>
                          </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </tbody>
                ...
                <div class="card-body p-0">
                  <div class="table-responsive">
                    <table class="table align-items-center mb-0">
                      ...
                      <tbody>
                        <?php $__currentLoopData = $completedExtensions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $extension): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          <th scope="row">
                            <button class="btn btn-icon btn-round btn-success btn-sm me-2">
                            <i class="fa fa-check"></i>
                          ...
                          <td class="text-end"><?php echo e($extension->proponents ?? 'N/A'); ?></td>
                          <td class="text-end"><?php echo e(\Carbon\Carbon::parse($extension->created_at)->toFormattedDateString()); ?></td>
                          <td class="text-end">
                            <span class="badge badge-success text-capitalize"><?php echo e($extension->status); ?></span>
                          </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </tbody>
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function () {
          ...
          notifDropdown.addEventListener('click', function (event) {
              ...
              console.log('Sending AJAX request to: <?php echo e(route('notifications.markAsRead')); ?>');
...
</html><?php /**PATH C:\xampp\htdocs\ojt_project\resources\views/dashboard.blade.php ENDPATH**/ ?>