                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo e($extension->title); ?></td>
                      <td><?php echo e($extension->proponents); ?></td>
                      <td><?php echo e(\Carbon\Carbon::parse($extension->start_date)->format('F d, Y')); ?></td>
                      <td><?php echo e(\Carbon\Carbon::parse($extension->end_date)->format('F d, Y')); ?></td>
                      <td>
                        <?php
                      ...
                      <td>
                        <div class="d-flex gap-2 align-items-center">
                          <!-- View Button -->
                          <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#extensionModal<?php echo e($extension->id); ?>">
                          View
                          </button>
                          <!-- Edit Button -->
                          <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#editModal<?php echo e($extension->id); ?>">
                          Edit
                          </button>
                          <!-- Delete Form -->
                          <form action="<?php echo e(route('extensions.destroy', $extension->id)); ?>" method="POST" class="m-0 p-0" onsubmit="return confirm('Are you sure you want to delete this extension?');">
                            <?php echo csrf_field(); ?>
                        ...
                        <!-- Edit Modal -->
                        <div class="modal fade" id="editModal<?php echo e($extension->id); ?>" tabindex="-1" aria-labelledby="editModalLabel<?php echo e($extension->id); ?>" aria-hidden="true">
                          <div class="modal-dialog modal-lg">
                            <!-- Widened modal -->
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="editModalLabel<?php echo e($extension->id); ?>">Edit Extension</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                              </div>
                              <div class="modal-body">
                                <form action="<?php echo e(route('extensions.update', $extension->id)); ?>" method="POST" enctype="multipart/form-data">
                                  <?php echo csrf_field(); ?>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-4">
                                      <div class="form-group mb-3">
                                        <label for="title<?php echo e($extension->id); ?>" class="form-label">Project Title</label>
                                        <input type="text" class="form-control" id="title<?php echo e($extension->id); ?>" name="title" value="<?php echo e($extension->title); ?>" required>
                                      </div>
                                      <div class="form-group mb-3">
                                        <label for="project_type<?php echo e($extension->id); ?>" class="form-label">Project Type</label>
                                        <select class="form-control" id="project_type<?php echo e($extension->id); ?>" name="project_type" required>
                                        <option value="Extension" <?php echo e($extension->project_type === 'Extension' ? 'selected' : ''); ?>>Extension</option>
                                        <option value="Outreach" <?php echo e($extension->project_type === 'Outreach' ? 'selected' : ''); ?>>Outreach</option>
                                        </select>
                                      </div>
                                      <div class="form-group mb-3">
                                        <label for="status<?php echo e($extension->id); ?>" class="form-label">Status</label>
                                        <select class="form-control" id="status<?php echo e($extension->id); ?>" name="status" required>
                                        <option value="pending" <?php echo e($extension->status === 'pending' ? 'selected' : ''); ?>>Pending</option>
                                        <option value="approved" <?php echo e($extension->status === 'approved' ? 'selected' : ''); ?>>Approved</option>
                                        <option value="ongoing" <?php echo e($extension->status === 'ongoing' ? 'selected' : ''); ?>>Ongoing</option>
                                        <option value="rejected" <?php echo e($extension->status === 'rejected' ? 'selected' : ''); ?>>Rejected</option>
                                        <option value="declined" <?php echo e($extension->status === 'declined' ? 'selected' : ''); ?>>Declined</option>
                                        <option value="completed" <?php echo e($extension->status === 'completed' ? 'selected' : ''); ?>>Completed</option>
                                        </select>
                                      </div>
                                      <div class="form-group mb-3">
                                        <label for="user_id<?php echo e($extension->id); ?>" class="form-label">Proponent (User)</label>
                                        <select name="user_id" class="form-control select2" id="user_id<?php echo e($extension->id); ?>" required>
                                          <option value="">Select User</option>
                                          <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <option value="<?php echo e($user->id); ?>" <?php echo e($extension->user_id == $user->id ? 'selected' : ''); ?>><?php echo e($user->name); ?></option>
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                      <div class="form-group mb-3">
                                        <label for="start_date<?php echo e($extension->id); ?>" class="form-label">Start Date</label>
                                        <input type="date" class="form-control" id="start_date<?php echo e($extension->id); ?>" name="start_date" value="<?php echo e($extension->start_date); ?>" required>
                                      </div>
                                      <div class="form-group mb-3">
                                        <label for="end_date<?php echo e($extension->id); ?>" class="form-label">End Date</label>
                                        <input type="date" class="form-control" id="end_date<?php echo e($extension->id); ?>" name="end_date" value="<?php echo e($extension->end_date); ?>" required>
                                      </div>
                                      <div class="form-group mb-3">
                                        <label for="months<?php echo e($extension->id); ?>" class="form-label">No. of Months</label>
                                        <input type="number" class="form-control" id="months<?php echo e($extension->id); ?>" name="months" value="<?php echo e($extension->months); ?>">
                                      </div>
                                    </div>
                                    <!-- Column 3: Proponents and Description -->
                                    <div class="col-md-4">
                                      <div class="form-group mb-3">
                                        <label for="proponents<?php echo e($extension->id); ?>" class="form-label">Additional Proponents</label>
                                        <textarea class="form-control" id="proponents<?php echo e($extension->id); ?>" name="proponents" rows="3"><?php echo e($extension->proponents); ?></textarea>
                                      </div>
                                      <div class="form-group mb-3">
                                        <label for="description<?php echo e($extension->id); ?>" class="form-label">Description / Notes</label>
                                        <textarea class="form-control" id="description<?php echo e($extension->id); ?>" name="description" rows="3"><?php echo e($extension->description); ?></textarea>
                                      </div>
                                    </div>
                                  </div>
                                  <!-- File Section -->
                                  ...
                                  ?>
                                  <?php $__currentLoopData = $fileLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <div class="row mb-3 align-items-center">
                                    <label class="col-md-3 col-form-label"><?php echo e($label); ?></label>
                                    <div class="col-md-6">
                                      <input type="file" class="form-control" id="<?php echo e($key); ?><?php echo e($extension->id); ?>" name="<?php echo e($key); ?>" accept=".pdf">
                                    </div>
                                    <div class="col-md-3">
                                      <?php if(!empty($extension->$key)): ?>
                                      <a href="<?php echo e(asset('storage/' . $extension->$key)); ?>" target="_blank" class="btn btn-sm btn-outline-primary">View Existing</a>
                                      <?php else: ?>
...
</html><?php /**PATH C:\xampp\htdocs\ojt_project\resources\views/forms/extension_list.blade.php ENDPATH**/ ?>