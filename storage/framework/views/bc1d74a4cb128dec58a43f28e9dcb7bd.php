      ...
      <div class="bg-white shadow-2xl rounded-2xl p-8 w-full max-w-md">
         ...
         <div class="flex justify-center space-x-4 mb-6">
            <div class="w-16 h-16 rounded-full overflow-hidden border-2 border-gray-300">
               <img src="<?php echo e(asset('assets/img/res.jpg')); ?>" alt="Logo 1" class="object-cover w-full h-full">
            </div>
            <div class="w-16 h-16 rounded-full overflow-hidden border-2 border-gray-300">
               <img src="<?php echo e(asset('assets/img/bagong_pilipinas.jpg')); ?>" alt="Logo 2" class="object-cover w-full h-full">
            </div>
            <div class="w-16 h-16 rounded-full overflow-hidden border-2 border-gray-300">
               <img src="<?php echo e(asset('assets/img/tup_logo.png')); ?>" alt="Logo 3" class="object-cover w-full h-full">
            </div>
         </div>
         ...
         <div class="mb-4">
            ...
            <p class="text-red-600 text-sm text-center"><?php echo e($error); ?></p>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
         </div>
         <?php endif; ?> 

         <form method="POST" action="<?php echo e(url('signup')); ?>" class="space-y-5">
            <?php echo csrf_field(); ?>
            <div>
            ...
            <p class="text-center text-sm text-gray-600">
                Already have an account? <a href="<?php echo e(url('signin')); ?>" class="text-blue-900 font-semibold hover:underline">Sign In</a>
            </p>
        </form>
...
<?php /**PATH C:\xampp\htdocs\ojt_project\resources\views/signup.blade.php ENDPATH**/ ?>